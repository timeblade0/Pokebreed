...
aa=instance_create(obj_shop_menu.x+20,obj_shop_menu.y+90,obj_item_buy_btn_parent)
    aa.cost=0; aa.name="Vacuum"; aa.sprite=spr_vacuum; aa.object=obj_vacuum; aa.sprite_index=spr_blue_light_btn; aa.scale=0.75
aa=instance_create(obj_shop_menu.x+70,obj_shop_menu.y+90,obj_item_buy_btn_parent)
    aa.cost=0; aa.name="Mushroom"; aa.sprite=spr_mushroom_1; aa.object=obj_mushroom_1; aa.sprite_index=spr_green_dark_btn; aa.scale=1
aa=instance_create(obj_shop_menu.x+120,obj_shop_menu.y+90,obj_item_buy_btn_parent)
    aa.cost=1; aa.name="Coin"; aa.sprite=spr_coin; aa.object=obj_coin; aa.sprite_index=spr_black_btn; aa.scale=1
//row 3
